...
public class InventoryConstants {
	...
	public static CustomInventory MENU_INVENTORY = new CustomInventory("§e§lMenu", 54);
	public static CustomInventory BOX_INVENTORY = new CustomInventory("§e§lRoleta", 54);
}
