...
public class InventoryConstants {
	...
	public static CustomPaginatedInventory MENU_INVENTORY = new CustomPaginatedInventory("§e§l" + Main.getLanguage().KIT_MENU_TITLE, 54);
	public static CustomPaginatedInventory BOX_INVENTORY = new CustomPaginatedInventory("§e§l" + Main.getLanguage().BOX_MENU_TITLE, 54);
